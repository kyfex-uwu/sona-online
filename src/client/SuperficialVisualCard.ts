...
export default class SuperficialVisualCard extends PositionedVisualGameElement{
    ...
    /**
     * Creates a superficial visual card
    ...
    constructor(game:ElementScene, card: Card|string, position: Vector3, rotation: Quaternion = new Quaternion()) {
        ...
        this.elScene.scene.add(this.model);
    }
